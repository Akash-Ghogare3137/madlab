...
# Load the dataset
data = pd.read_csv('Bank_dataset_2.csv')  # Replace with your actual file path
...
# Only provide the 'Duration' value for prediction since it's the only feature
new_customer_data = np.array([[300]])  # Replace 300 with the actual duration value for the new customer

# Create a DataFrame with the correct number of columns
new_customer_df = pd.DataFrame(new_customer_data, columns=['Duration'])
